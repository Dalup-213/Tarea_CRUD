...
<div class="max-w-5xl mx-auto">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('students.create') }}" class="bg-orange-400 text-white px-4 py-2 rounded hover:bg-orange-700">Nuevo Estudiante</a>
    </div>
        ...
        <tbody>
            ...
            <tr class="border-t hover:bg-gray-50">
                ...
                <td class="py-2 px-4 text-center space-x-2">
                    ...
                    <a href="{{ route('students.edit', $student->id) }}" class="bg-purple-400 text-white px-3 py-1 rounded hover:bg-purple-700">Editar</a>
                    <form action="{{ route('students.delete', $student->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button onclick="return confirm('¿Eliminar estudiante?')" class="bg-pink-500 text-white px-3 py-1 rounded hover:bg-pink-600">Eliminar</button>
                    </form>
                </td>
            </tr>
            @endforeach
